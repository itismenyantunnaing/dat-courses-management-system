...
public class ManagementSkillDto {
    ...
    @Max(value = 4, message = "QCD score must be at most 4")
    private Short qcdScore;
    
    @Min(value = 0, message = "Report consult score must be at least 0")
    @Max(value = 4, message = "Report consult score must be at most 4")
    private Short reportConsultScore;
    
    @Min(value = 0, message = "Education score must be at least 0")
    @Max(value = 4, message = "Education score must be at most 4")
    private Short educationScore;
    
    @DecimalMin(value = "0", message = "Total level must be at least 0")
    @DecimalMax(value = "5", message = "Total level must be at most 5")
