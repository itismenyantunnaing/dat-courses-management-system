...
export function InformationTab({
  ...
  const { fetch_courseEnrollments, studyProgress, fetch_studyProgress, add_studyProgress, update_studyProgress } = mainStore()
                                          ...
                                          <div className="mt-2 space-y-1">
                                            {groupEmployees
                                              .filter((employee) => {
                                                ...
                                                if (isDepartmentHead && profile?.deptDat) {
                                                  return employee.departmentName === profile.deptDat
                                                }
                                                return true
                                              })
                                              .slice(0, 3)
                                                  ...
                                                  >
                                                    <div className="flex items-center gap-1.5">
                                                      ...
                                                      <span className="text-[10px]">
                                                        {truncateText(employee.employeeName, 15)}
                                                      </span>
                                                    </div>
                                                    {currentStatus ? (
              ...
              {filteredEnrollments.length > 9 && (
                ...
                >
                  <HugeiconsIcon
                    ...
                    className="h-3 w-3"
                  />
                  {showFullLearners ? "Show Less" : `View All (${filteredEnrollments.length})`}
                </Button>
              )}
            </div>
